...
public class TaskDetailFragment extends Fragment {
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    loggedInUserId = UserList.getInstance(getActivity()).getLoggedInUserId();
  }// end of onCreate()
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    if (taskId == null) {
      mClickedTask = new Task(loggedInUserId);
      prepareForAdd();
      isNewTask = true;

    } else {
      mClickedTask = TaskList.getInstance(getActivity()).getTask(taskId, loggedInUserId);
      prepareForUpdate();
      isNewTask = false;
